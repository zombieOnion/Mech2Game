...
public partial class @Mech_Controller: IInputActionCollection2, IDisposable
{
    ...
    private List<IMechPilotActions> m_MechPilotActionsCallbackInterfaces = new List<IMechPilotActions>();
    ...
    public struct MechPilotActions
    {
        ...
        public void AddCallbacks(IMechPilotActions instance)
        {
            if (instance == null || m_Wrapper.m_MechPilotActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_MechPilotActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IMechPilotActions instance)
        {
            @Move.started -= instance.OnMove;
            @Move.performed -= instance.OnMove;
            @Move.canceled -= instance.OnMove;
        ...
        public void RemoveCallbacks(IMechPilotActions instance)
        {
            if (m_Wrapper.m_MechPilotActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IMechPilotActions instance)
        {
            foreach (var item in m_Wrapper.m_MechPilotActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_MechPilotActionsCallbackInterfaces.Clear();
    ...
    private List<IElectronicWarfareOfficerActions> m_ElectronicWarfareOfficerActionsCallbackInterfaces = new List<IElectronicWarfareOfficerActions>();
    ...
    public struct ElectronicWarfareOfficerActions
    {
        ...
        public void AddCallbacks(IElectronicWarfareOfficerActions instance)
        {
            if (instance == null || m_Wrapper.m_ElectronicWarfareOfficerActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_ElectronicWarfareOfficerActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(IElectronicWarfareOfficerActions instance)
        {
            @IncreaseMinimapResolution.started -= instance.OnIncreaseMinimapResolution;
            @IncreaseMinimapResolution.performed -= instance.OnIncreaseMinimapResolution;
            @IncreaseMinimapResolution.canceled -= instance.OnIncreaseMinimapResolution;
        ...
        public void RemoveCallbacks(IElectronicWarfareOfficerActions instance)
        {
            if (m_Wrapper.m_ElectronicWarfareOfficerActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(IElectronicWarfareOfficerActions instance)
        {
            foreach (var item in m_Wrapper.m_ElectronicWarfareOfficerActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_ElectronicWarfareOfficerActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
